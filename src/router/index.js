...
const rootRoutes = {
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "start",
          name: "start",
          component: () => import("@/views/root/packages-demo/start/Start.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "快速开始 Start",
        ...
        },
        {
          ...
          name: "yulang-switch",
          component: () =>
            import("@/views/root/packages-demo/yulang-switch/YulangSwitch.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "开关 Switch",
        ...
        },
        {
          ...
          name: "yulang-slider",
          component: () =>
            import("@/views/root/packages-demo/yulang-slider/YulangSlider.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "滑块 Slider",
        ...
        },
        {
          ...
          name: "yulang-upload",
          component: () =>
            import("@/views/root/packages-demo/yulang-upload/YulangUpload.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "上传 Upload",
        ...
        },
        {
          ...
          name: "yulang-canvas",
          component: () =>
            import("@/views/root/packages-demo/yulang-canvas/YulangCanvas.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "画布 Canvas",
        ...
        },
        {
          ...
          name: "yulang-dialog",
          component: () =>
            import("@/views/root/packages-demo/yulang-dialog/YulangDialog.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "对话框 Dialog",
        ...
        },
        {
          ...
          name: "yulang-leader",
          component: () =>
            import("@/views/root/packages-demo/yulang-leader/YulangLeader.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "引导 Leader",
        ...
        },
        {
          ...
          name: "yulang-select",
          component: () =>
            import("@/views/root/packages-demo/yulang-select/YulangSelect.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "下拉框 Select",
        ...
        },
        {
          ...
          name: "yulang-drawer",
          component: () =>
            import("@/views/root/packages-demo/yulang-drawer/YulangDrawer.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
        ...
        },
        {
          ...
          name: "yulang-avatar",
          component: () =>
            import("@/views/root/packages-demo/yulang-avatar/YulangAvatar.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
            title: "头像 Avatar",
    ...
    },
    {
      ...
      name: "theme",
      component: () =>
        import(/* webpackChunkName: "about" */ "@/views/root/theme/Theme.vue"),
      meta: {
        keepAlive: true,
        isAuth: true,
      },
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "animate",
          name: "animate",
          component: () => import("@/views/root/resources/animate/Animate.vue"),
          meta: {
            keepAlive: true,
            isAuth: true,
...
const routes = [
  ...
  },
  {
    ...
    name: "zh-CN",
    component: () =>
      import(/* webpackChunkName: "about" */ "@/views/locale/Zh.vue"),
    meta: {
      keepAlive: false,
      isAuth: true,
    },
  ...
  },
  {
    ...
    name: "en-US",
    component: () =>
      import(/* webpackChunkName: "about" */ "@/views/locale/En.vue"),
    meta: {
      keepAlive: false,
      isAuth: true,
    },
...
router.beforeEach((to, from, next) => {
  if (to.path === "/") {
    next(`/${Vue.prototype.$locale.locale}`);
  } else {
    Vue.prototype.$locale.cl(to.path.split("/")[1]);
